...
public class Select_Flight extends basic_utility
{
    ...
    private void flights_Bali(Package p)
    {
        ...
        f[2] = new Flight("     Emirates   ", "03:15 New Delhi", "12:05 Denpasar Bali", "11:35 Denpasar Bali", "19:25 New Delhi", 1544,false);
    ...
    private void flights_Dubai(Package p)
    {
        ...
        f[2] = new Flight("    Emirates  ", "03:15 New Delhi", "12:05 Dubai", "11:35 Dubai", "19:25 New Delhi", 1544,false);
    ...
    private void flights_Singapore(Package p)
    {
        ...
        f[2] = new Flight("     Emirates   ", "03:15 New Delhi", "12:05 Singapore", "11:35 Singapore", "19:25 New Delhi", 1544,false);
    ...
    private void flights_Bhutan(Package p)
    {
        ...
        f[2] = new Flight("    Emirates  ", "03:15 New Delhi", "12:05 Bhutan", "11:35 Bhutan", "19:25 New Delhi", 1544,false);
